...
def get_daily_papers(query='slam', max_results=2):
    ...
    for result in search_engine.results():
        ...
        logging.info(
            f'Time = {update_time} title = {paper_title} author = {paper_first_author}'  # noqa
        )
        ...
        try:
            ...
            if repo_url is not None:
                content[
                    paper_key] = '|**{}**|**{}**|{} et.al.|[{}]({})|[link]({})|null|\n'.format(  # noqa
                        update_time, paper_title, paper_first_author, paper_id,
                        paper_url, repo_url)
            else:
                content[
                    paper_key] = '|**{}**|**{}**|{} et.al.|[{}]({})|null|null|\n'.format(  # noqa
                        update_time, paper_title, paper_first_author, paper_id,
                        paper_url)
...
def json_to_md(filename, md_filename, task='', to_web=False, use_title=True):
    ...
    with open(md_filename, 'a+') as f:
        ...
        for keyword in data.keys():
            ...
            # Add: back to top
            f.write(
                f'<p align=right>(<a href=## {keyword}>back to top</a>)</p>\n\n'  # noqa
            )  # TODO
